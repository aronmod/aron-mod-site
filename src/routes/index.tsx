      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-2 px-4 py-3 sm:grid sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center sm:gap-4 sm:px-6">
        ...
        <nav className="flex shrink-0 items-center gap-1.5 sm:gap-3">
          ...
          <div className="ml-auto flex items-center gap-2 sm:gap-3 md:ml-6 lg:ml-10">
            <a
              href="#prezzi"
              className="flex h-[30px] shrink-0 items-center rounded-md bg-[image:var(--gradient-accent)] px-2 text-[13px] font-semibold text-primary-foreground transition-all hover:brightness-110 max-[420px]:h-7 max-[420px]:px-1.5 max-[420px]:text-xs"
            >
              {t.header.buy}
            </a>
  ...
  return (
    <section id="top" className="relative overflow-hidden bg-background">
      ...
      <div className="relative mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 sm:py-24">
        ...
        >
          <p className="text-lg leading-relaxed font-normal text-foreground sm:text-xl">
            {t.hero.subtitle.line1}
          </p>
          <p className="text-base leading-relaxed font-normal text-foreground sm:text-xl">
...
function SupportCell({
  ...
  const pad = size === "xs" ? "p-0.5" : size === "sm" ? "p-1" : "p-1";
  const icon = size === "xs" ? "h-3 w-3" : size === "sm" ? "h-3 w-3" : "h-3.5 w-3.5";
  if (value === true) {
    return (
      <span
